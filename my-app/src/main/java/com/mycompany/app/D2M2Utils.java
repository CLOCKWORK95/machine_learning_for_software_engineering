...
public class D2M2Utils {
	...
	public static List<Integer> walkForwardTraining(String projectName, int trainingLimit) throws IOException {
		...
		try (FileWriter csvWriter = new FileWriter("/home/gianmarco/Scrivania/ML_4_SE/my-app/src/main/java/com/mycompany/app/output/" +projectName + TRAINING)) {
			...
			try (BufferedReader br = new BufferedReader(new FileReader( "/home/gianmarco/Scrivania/ML_4_SE/my-app/src/main/java/com/mycompany/app/output/" + projectName + "_dataset.csv"))){ 
