...
public class Deliverable2Milestone2 {
	...
	public static void deliverable2() throws Exception{
		...
		for (int j = 0; j < projects.length; j++) {
			...
			try (FileWriter csvWriter = new FileWriter("/home/gianmarco/Scrivania/ML_4_SE/my-app/src/main/java/com/mycompany/app/output/outputD2M2_" + projects[j]+ ".csv")) {
